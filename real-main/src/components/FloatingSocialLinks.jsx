    ...
    <div className="fixed right-1 top-1/2 -translate-y-1/2 z-50">
      <div className="flex flex-col items-start">
        <button
          ...
          className="bg-orange-600 text-white p-3 rounded-r-lg shadow-lg hover:bg-orange-500 transition-all duration-300 mb-2"
        ...
        >
          {socialLinks.map((social) => (
            <a
              ...
              className={`bg-gray-800 text-white p-3 rounded-r-lg shadow-lg transition-all duration-300 ${social.color} group`}
